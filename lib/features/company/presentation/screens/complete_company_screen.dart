...
class CompleteCompanyScreen extends ConsumerStatefulWidget {
  const CompleteCompanyScreen({super.key});

  @override
  ConsumerState<CompleteCompanyScreen> createState() =>
      _CompleteCompanyScreenState();
}

class _CompleteCompanyScreenState extends ConsumerState<CompleteCompanyScreen> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Create your company profile to start posting internships and reaching students.',
                      style: AppTextStyles.bodyMedium
